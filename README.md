...
GML Map Tool is a Web Tool that allows you to create a directed complete Graph in GML format, using Google Maps as a data source. Draw an arc or route directly in the maps via JSON file [Try It !](http://www.alexanderperucci.com/portfolio-demo/gmlmaptool/)
